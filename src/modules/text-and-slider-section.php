<section class="text-and-slider-section with-lines">
    <div class="text-and-slider-section__main">
            ...
            <div class="row">
                ...
                <div class="col-12 order-xl-3">
                    <div class="text-and-slider-section__controls">
                        ...
                        <div class="text-and-slider-section__slider-scrollbar">
                            <div class="scrollbar"></div>
                        </div>
                        <div class="slider-arrows text-and-slider-section__slider-arrows">
        ...
        <!--                    <div class="text-and-slider__fraction swiper-pagination">-->
        <!--                        01 / 21-->
        <!--                    </div>-->
        <!--                </div>-->
